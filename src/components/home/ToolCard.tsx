...
import { ToolIcon } from './toolStyle';
...
export function ToolCard({
  ...
  const content = (
    <div className="flex gap-4 h-full">
      {/* Icon tile (left): 44px, rounded-md, surface-card bg, primary-red icon */}
      <div className="flex-shrink-0 w-11 h-11 rounded-md bg-surface-card flex items-center justify-center border border-hairline">
